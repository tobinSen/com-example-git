 ...
 * @created 2014-10-03
 * <p>
 * 1T -> 1*1024 G -> 1*1024*1024 M -> 1*1024*1024*1024 KB -> 1*1024*1024*1024*1024 bytes -> 1*1024*1024*1024*1024*8 bit
 */
public class ObjectSize {

    public static void main(String[] args) {
        System.out.println(1 + "T");
        System.out.println(1 * 1024 + "G");
        System.out.println(1 * 1024 * 1024 + "M");
        System.out.println(1 * 1024 * 1024 * 1024 + "KB");
        System.out.println(1 * 1024L * 1024L * 1024L * 1024L + "bytes");
        System.out.println(1 * 1024L * 1024L * 1024L * 1024L * 8 + "bit");
...
//                    对象头 = markerWord 8 + klass 4 + 数组长度(数据类型) 4
//                    实例数据 = 4 * 100
//                    对齐填充：416 是8个倍数
//         */
...
//         *         共24+832 = 856字节
//
//          对象头：markerWorld 8 + 4 + 4 -> 16 + 16 --> 24
//                4 * 100 = 400 ->对齐 -> 416
//
//         */
