...
import {
    ...
    CURSOR_BLINK_CLASS,
    CURSOR_STYLE_BAR_CLASS,
    CURSOR_STYLE_UNDERLINE_CLASS,
    DomRendererRowFactory
} from 'browser/renderer/dom/DomRendererRowFactory';
...
export class DomRenderer extends Disposable implements IRenderer {
    ...
    public get onRequestRefreshRows(): IEvent<IRequestRefreshRowsEvent> {
