...
export class InputHandler extends Disposable implements IInputHandler {
    ...
    public get onRequestRefreshRows(): IEvent<number, number> {
        return this._onRequestRefreshRows.event;
    }

    private _onRequestReset = new EventEmitter<void>();
    public get onRequestReset(): IEvent<void> {
        return this._onRequestReset.event;
    }

    private _onRequestBell = new EventEmitter<void>();
    public get onRequestBell(): IEvent<void> {
    ...
    constructor(
         ...
         */
        //   0 - icon name + title
        this._parser.setOscHandler(0, new OscHandler((data: string) => {
            this.setTitle(data);
         ...
         * DCS handler
         */
        this._parser.setDcsHandler({
            intermediates: '$',
            final: 'q'
        }, new DECRQSS(this._bufferService, this._coreService, this._logService, this._optionsService));
    }
